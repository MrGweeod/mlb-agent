...
**Last Updated:** August 5, 2026 (Session 27 — leg-scoring redesign shipped: composite_score back-tested at AUC 0.48-0.49 (no better than random); shipped the evidence-backed fixes per-component instead of waiting on full validation for all of them — totalBases promoted to the live pool, hits/over exposure-weighted ERA, scorer_version instrumentation)
